...
func newSysConfig(db *gorm.DB, opts ...gen.DOOption) sysConfig {
	...
	_sysConfig.ConfigID = field.NewString(tableName, "config_id")
	_sysConfig.TenantID = field.NewString(tableName, "tenant_id")
	...
	_sysConfig.CreateDept = field.NewInt64(tableName, "create_dept")
	_sysConfig.CreateBy = field.NewInt64(tableName, "create_by")
	_sysConfig.CreateTime = field.NewTime(tableName, "create_time")
	_sysConfig.UpdateBy = field.NewInt64(tableName, "update_by")
...
func (s *sysConfig) updateTableName(table string) *sysConfig {
	...
	s.ConfigID = field.NewString(table, "config_id")
