...
func newSysPost(db *gorm.DB, opts ...gen.DOOption) sysPost {
	...
	_sysPost.CreateDept = field.NewInt64(tableName, "create_dept")
	_sysPost.CreateBy = field.NewInt64(tableName, "create_by")
	_sysPost.CreateTime = field.NewTime(tableName, "create_time")
	_sysPost.UpdateBy = field.NewInt64(tableName, "update_by")
...
func (s *sysPost) fillFieldMap() {
	...
	s.fieldMap["post_category"] = s.PostCategory
