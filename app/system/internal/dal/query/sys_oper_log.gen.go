...
func newSysOperLog(db *gorm.DB, opts ...gen.DOOption) sysOperLog {
	...
	_sysOperLog.OperID = field.NewString(tableName, "oper_id")
	_sysOperLog.TenantID = field.NewString(tableName, "tenant_id")
...
func (s *sysOperLog) updateTableName(table string) *sysOperLog {
	...
	s.OperID = field.NewString(table, "oper_id")
