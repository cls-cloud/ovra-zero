...
func newSysNotice(db *gorm.DB, opts ...gen.DOOption) sysNotice {
	...
	_sysNotice.NoticeID = field.NewString(tableName, "notice_id")
	_sysNotice.TenantID = field.NewString(tableName, "tenant_id")
	_sysNotice.NoticeTitle = field.NewString(tableName, "notice_title")
	_sysNotice.NoticeType = field.NewString(tableName, "notice_type")
	_sysNotice.NoticeContent = field.NewBytes(tableName, "notice_content")
	_sysNotice.Status = field.NewString(tableName, "status")
	_sysNotice.CreateDept = field.NewInt64(tableName, "create_dept")
	_sysNotice.CreateBy = field.NewInt64(tableName, "create_by")
	_sysNotice.CreateTime = field.NewTime(tableName, "create_time")
	_sysNotice.UpdateBy = field.NewInt64(tableName, "update_by")
...
func (s *sysNotice) updateTableName(table string) *sysNotice {
	...
	s.NoticeID = field.NewString(table, "notice_id")
	...
	s.NoticeContent = field.NewBytes(table, "notice_content")
