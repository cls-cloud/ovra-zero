...
func newSysMenu(db *gorm.DB, opts ...gen.DOOption) sysMenu {
	...
	_sysMenu.QueryParam = field.NewString(tableName, "query_param")
...
func (s *sysMenu) updateTableName(table string) *sysMenu {
	...
	s.QueryParam = field.NewString(table, "query_param")
...
func (s *sysMenu) fillFieldMap() {
	...
	s.fieldMap["query_param"] = s.QueryParam
