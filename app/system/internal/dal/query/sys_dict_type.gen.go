...
func newSysDictType(db *gorm.DB, opts ...gen.DOOption) sysDictType {
	...
	_sysDictType.CreateDept = field.NewInt64(tableName, "create_dept")
	_sysDictType.CreateBy = field.NewInt64(tableName, "create_by")
	_sysDictType.CreateTime = field.NewTime(tableName, "create_time")
	_sysDictType.UpdateBy = field.NewInt64(tableName, "update_by")
