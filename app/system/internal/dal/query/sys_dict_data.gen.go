...
func newSysDictDatum(db *gorm.DB, opts ...gen.DOOption) sysDictDatum {
	...
	_sysDictDatum.CreateDept = field.NewInt64(tableName, "create_dept")
	_sysDictDatum.CreateBy = field.NewInt64(tableName, "create_by")
	_sysDictDatum.CreateTime = field.NewTime(tableName, "create_time")
	_sysDictDatum.UpdateBy = field.NewInt64(tableName, "update_by")
